...
#ekos.copy_workspace(source_uuid='default_workspace', target_alias='lena_indicator')
...
# w.copy_subset(source_uuid='default_subset', target_alias='period_2007-2012_refvalues_2006')
